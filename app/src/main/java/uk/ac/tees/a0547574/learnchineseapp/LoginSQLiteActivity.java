...
import uk.ac.tees.a0547574.learnchineseapp.Bean.UserInfo;
import uk.ac.tees.a0547574.learnchineseapp.Database.UserDBHelper;
import uk.ac.tees.a0547574.learnchineseapp.Util.DateUtil;
import uk.ac.tees.a0547574.learnchineseapp.Util.ViewUtil;
...
public class LoginSQLiteActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private void loginSuccess() {
        String desc = String.format("您的手机号码是%s，类型是%s。恭喜你通过登录验证，点击“确定”按钮进入学习界面。",
                et_phone.getText().toString(), typeArray[mType]);
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("登录成功");
        builder.setMessage(desc);
        builder.setPositiveButton("确定进入", new DialogInterface.OnClickListener() {
            @Override
