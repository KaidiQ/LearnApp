...
import uk.ac.tees.a0547574.learnchineseapp.Bean.ChengyuBean;
import uk.ac.tees.a0547574.learnchineseapp.Bean.PinBuWordBean;
import uk.ac.tees.a0547574.learnchineseapp.Bean.WordBean;
...
//                调用单个对象插入的方法
    ...
    public static List<PinBuWordBean.ResultBean.ListBean>queryPyWordFromPywordtb(String py,int page,int pagesize){
        ...
        while (cursor.moveToNext()) {
            ...
            String py1 = cursor.getString(cursor.getColumnIndexOrThrow("py"));
            String wubi = cursor.getString(cursor.getColumnIndexOrThrow("wubi"));
            String pinyin = cursor.getString(cursor.getColumnIndexOrThrow("pinyin"));
            String bushou = cursor.getString(cursor.getColumnIndexOrThrow("bushou"));
            String bihua = cursor.getString(cursor.getColumnIndexOrThrow("bihua"));
...
//        将集合转化成字符串类型进行插入
    ...
    public static WordBean.ResultBean queryWordFromWordtb(String word){
        ...
        if (cursor.moveToFirst()) {
            ...
            String bushou = cursor.getString(cursor.getColumnIndexOrThrow("bushou"));
            String bihua = cursor.getString(cursor.getColumnIndexOrThrow("bihua"));
            String jijie = cursor.getString(cursor.getColumnIndexOrThrow("jijie"));
            String xiangjie = cursor.getString(cursor.getColumnIndexOrThrow("xiangjie"));
    ...
    public static ChengyuBean.ResultBean queryCyFromCyutb(String cyu){
        ...
        if (cursor.moveToFirst()) {
            ...
            String bushou = cursor.getString(cursor.getColumnIndexOrThrow("bushou"));
            String head = cursor.getString(cursor.getColumnIndexOrThrow("head"));
            String pinyin = cursor.getString(cursor.getColumnIndexOrThrow("pinyin"));
            String chengyujs = cursor.getString(cursor.getColumnIndexOrThrow("chengyujs"));
            String from_ = cursor.getString(cursor.getColumnIndexOrThrow("from_"));
            String example = cursor.getString(cursor.getColumnIndexOrThrow("example"));
            String yufa = cursor.getString(cursor.getColumnIndexOrThrow("yufa"));
            String ciyujs = cursor.getString(cursor.getColumnIndexOrThrow("ciyujs"));
            String yinzhengjs = cursor.getString(cursor.getColumnIndexOrThrow("yinzhengjs"));
            String tongyi = cursor.getString(cursor.getColumnIndexOrThrow("tongyi"));
            String fanyi = cursor.getString(cursor.getColumnIndexOrThrow("fanyi"));
