...
public class UserDBhelp extends SQLiteOpenHelper{
    ...
    private UserDBhelp(Context context, int version) {
        super(context, DB_NAME, null, version);
    }

    public static UserDBhelp getInstance(Context context, int version) {
        if (version > 0 && mHelper == null) {
            mHelper = new UserDBhelp(context, version);
